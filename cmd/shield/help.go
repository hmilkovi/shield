...
func ShowHelp(command string) {
	...
	/* }}} */
	case "create-policy": /* {{{ */
		fmt.Printf("USAGE: @G{shield} create-policy --tenant @Y{TENANT} [OPTIONS]\n")
		fmt.Printf("\n")
		...
		fmt.Printf("  @W{shield create-policy}                   \\\n")
	...
	case "create-policy-template": /* {{{ */
		fmt.Printf("USAGE: @G{shield} create-policy-template [OPTIONS]\n")
		fmt.Printf("\n")
		...
		fmt.Printf("  see @C{shield create-policy}.\n")
		fmt.Printf("\n")
		fmt.Printf("@B{Options:}\n")
		fmt.Printf("\n")
	...
	case "create-target": /* {{{ */
		...
		fmt.Printf("                  target. Valid values are `bzip2' and `none'\n")
		fmt.Printf("\n")
	...
	/* }}} */
	case "delete-policy": /* {{{ */
		fmt.Printf("USAGE: @G{shield} delete-policy --tenant @Y{TENANT} @Y{NAME-OR-UUID}\n")
		fmt.Printf("\n")
	...
	case "delete-policy-template": /* {{{ */
		fmt.Printf("USAGE: @G{shield} delete-policy-template @Y{NAME-OR-UUID}\n")
		fmt.Printf("\n")
		...
		fmt.Printf("  are first created.  Only SHIELD site engineers can use this\n")
		fmt.Printf("  command; for managing retention policies in your own tenant(s),\n")
		fmt.Printf("  see @C{shield delete-policy}.\n")
		fmt.Printf("\n")
	...
	/* }}} */
	case "policies": /* {{{ */
		fmt.Printf("USAGE: @G{shield} policies --tenant @Y{TENANT} [OPTIONS]\n")
		fmt.Printf("\n")
	...
	/* }}} */
	case "policy": /* {{{ */
		fmt.Printf("USAGE: @G{shield} policy --tenant @Y{TENANT} @Y{NAME-OR-UUID}\n")
		fmt.Printf("\n")
	...
	case "policy-template": /* {{{ */
		fmt.Printf("USAGE: @G{shield} policy-template @Y{NAME-OR-UUID}\n")
		fmt.Printf("\n")
		...
		fmt.Printf("  are first created.  Only SHIELD site engineers can use this\n")
		fmt.Printf("  command; for managing retention policies in your own tenant(s),\n")
		fmt.Printf("  see @C{shield policy}.\n")
		fmt.Printf("\n")
		fmt.Printf("\n")

	/* }}} */
	case "policy-templates": /* {{{ */
		fmt.Printf("USAGE: @G{shield} policy-templates\n")
		fmt.Printf("\n")
		...
		fmt.Printf("  are first created.  Only SHIELD site engineers can use this\n")
		fmt.Printf("  command; for managing retention policies in your own tenant(s),\n")
		fmt.Printf("  see @C{shield policies}.\n")
		fmt.Printf("\n")
		fmt.Printf("\n")
	...
	/* }}} */
	case "update-policy": /* {{{ */
		fmt.Printf("USAGE: @G{shield} update-policy --tenant @Y{TENANT} [OPTIONS] @Y{NAME-OR-UUID}\n")
		fmt.Printf("\n")
		...
		fmt.Printf("  @W{shield update-policy} Short-Term \\\n")
	...
	case "update-policy-template": /* {{{ */
		fmt.Printf("USAGE: @G{shield} update-policy-template [OPTIONS] @Y{NAME-OR-UUID}\n")
		fmt.Printf("\n")
		...
		fmt.Printf("  are first created.  Only SHIELD site engineers can use this\n")
		fmt.Printf("  command; for managing retention policies in your own tenant(s),\n")
		fmt.Printf("  see @C{shield update-policy}.\n")
		fmt.Printf("\n")
		fmt.Printf("@B{Options:}\n")
		fmt.Printf("\n")
		fmt.Printf("  Updates are entirely specified via command-line arguments.\n")
